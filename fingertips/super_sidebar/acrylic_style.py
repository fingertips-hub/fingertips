...
class WindowEffect():
    ...
    def setAcrylicEffect(self, hWnd: int, gradientColor: str = '00000064',
                         isEnableShadow: bool = False, animationId: int = 0):
        """ 开启亚克力效果
        ...
        accentPolicy.AccentState = ACCENT_STATE.ACCENT_ENABLE_ACRYLICBLURBEHIND.value[0]
        ...
        # 开启亚克力
        self.SetWindowCompositionAttribute(hWnd, pointer(winCompAttrData))
